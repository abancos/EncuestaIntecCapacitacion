    ...
    public partial class Resultados : System.Web.UI.Page
    {
        ...
        public void Cargar()
        {
            ...
            try
            {
                ...
                rgResultados.DataSource = objCtrl.SelEncuesta(objInfo);
                rgResultados.DataBind();

                rgResultados0.DataSource = objCtrl.SelEncuesta(objInfo);
        ...
        protected void rgResultados_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                objInfo.ID_Encuesta = int.Parse(cboEncuesta.SelectedValue);
